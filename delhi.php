...
<body class="body">
  ...
  <h1 class="head1">Booking For Delhi Hotels</h1>
  <div ng-app="myApp" ng-controller="myCtrl">
    ...
    <form action="" id="form" method="POST" name="myForm" onsubmit="return validateForm()">
      ...
      <input type="text" name="lname" class="name" autofocus size="25" ng-model="lname"> <br>
      ...
      <select name="hotel" id="room" required>
        ...
        <option value="Novotel New Delhi International Airport">Novotel New Delhi International Airport</option>
        <option value="Taj Palace, New Delhi">Taj Palace, New Delhi</option>
        <option value="Holiday Inn New Delhi International Airport, an IHG Hotel">Holiday Inn New Delhi International Airport, an IHG Hotel</option>
        <option value="Shangri-La's - Eros Hotel, New Delhi">Shangri-La's - Eros Hotel, New Delhi</option>
        <option value="The Claridges New Delhi">The Claridges New Delhi</option>
        <option value="Vivanta New Delhi, Dwarka">Vivanta New Delhi, Dwarka</option>
        <option value=" Ibis New Delhi International Airport"> Ibis New Delhi International Airport</option>
        <option value="Radisson Blu Plaza Delhi Airpor"> Radisson Blu Plaza Delhi Airpor</option>
...
if (isset($_POST['Submit'])) {
    ...
    $result = mysqli_query($con, "INSERT INTO delhi  VALUES ('$fname', '$lname', '$email','$adult','$children', '$city','$hotel',$p_number,'$indate','$outdate')");
