  ...
  <div ng-app="myApp" ng-controller="myCtrl">
    ...
    <form action="" id="form" method="POST" name="myForm" onsubmit="return validateForm()">
      ...
      <select name="hotel" id="room" required>
        ...
        <option value="Savoy - IHCL SeleQtions">Savoy - IHCL SeleQtions</option>
        <option value="Treebo Trend Sky Dale Inn & Suites,Ooty">Treebo Trend Sky Dale Inn & Suites,Ooty</option>
        <option value="Sterling Ooty Fern Hill">Sterling Ooty Fern Hill</option>
        <option value="Fortune Resort Sullivan Court - Member ITC Hotel Group, Ooty">Fortune Resort Sullivan Court - Member ITC Hotel Group, Ooty</option>
        <option value="Sterling Ooty Elk Hill">Sterling Ooty Elk Hill</option>
        <option value="The Majestic Crown">The Majestic Crown</option>
        <option value=" Beverly Villa"> Beverly Villa</option>
        <option value="Western Valley Resorts"> Western Valley Resorts</option>
...
if (isset($_POST['Submit'])) {
    ...
    $result = mysqli_query($con, "INSERT INTO ooty  VALUES ('$fname', '$lname', '$email','$adult','$children', '$city','$hotel',$p_number,'$indate','$outdate')");
