...
<body class="body">
  ...
  <h1 class="head1">Booking For Mumbai Hotels</h1>
  <div ng-app="myApp" ng-controller="myCtrl">
    ...
    <form action="" id="form" method="POST" name="myForm" onsubmit="return validateForm()">
      ...
      <select name="hotel" id="room" required>
        ...
        <option value="Taj Lands End">Taj Lands End</option>
        <option value="ITC Maratha">ITC Maratha</option>
        <option value="Triedent Nariman Point">Triedent Nariman Point</option>
        <option value="Grand Hyatt Hotel and Residence">Grand Hyatt Hotel and Residence</option>
        ...
        <option value="Hyatt Regency Mumbai International Airport"> Hyatt Regency Mumbai International Airport</option>
...
if (isset($_POST['Submit'])) {
    ...
    $result = mysqli_query($con, "INSERT INTO mum  VALUES ('$fname', '$lname', '$email','$adult','$children', '$city','$hotel',$p_number,'$indate','$outdate')");
